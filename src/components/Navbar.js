...
export default function Navbar() {
  ...
  return (
    <nav className="h-[64px] bg-white dark:bg-gray-900 border-b border-gray-200 flex items-center justify-between px-4 md:px-8 sticky top-0 z-50">
        ...
        {user ? (
          <>
            ...
            <div className="relative">
              <button onClick={() => setShowNotifications(!showNotifications)} className="text-gray-600 dark:text-gray-400 hover:text-black">
                <Bell size={20} />
              </button>
              {showNotifications && (
                <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-900 rounded-xl shadow-xl border border-gray-200 p-4 z-50">
                  <h3 className="font-bold text-gray-900 dark:text-white mb-2">Notifications</h3>
                  <div className="text-sm text-gray-500 dark:text-gray-400 py-4 text-center">No new notifications</div>
                </div>
              )}
            </div>
